export default {
    ...
    read: (req, resource, params, config, callback) => {
        ...
        if(resource === 'questions.list'){
            ...
            let questions = [
                {id: 12, title: 'Super exciting question', username: 'Ilya B.', userID: 66, difficulty: 3, Date: 'yesterday',
                ...
                {id: 23, title: 'Title for question 2', username: 'Vuk M.', userID: 7, difficulty: 2, Date: '2 hours agp',
                ...
                {id: 40, title: 'Very difficult question', username: 'Ali K', userID: 23, difficulty: 4, Date: '23 minutes ago',
                ...
                {id: 22, title: 'Extriemly hard to answer', username: 'Ali K', userID: 23, difficulty: 5, Date: 'yesterday',
