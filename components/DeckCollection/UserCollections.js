                        ...
                        <div key={col._id} className="ui vertical segment">
                            <div className="ui two column stackable grid container">
                                <div className="column">
                                    <div className="ui small header medium"><h2><a href={`/playlist/${col._id}?sort=order`} target='_blank'>{col.title}</a></h2></div>
                                    <div className="meta">
        ...
        return (
            <div className="ui segments">
                ...
                <div className="ui secondary clearing segment">
                    <h1 className="ui left floated header medium" id="main">{this.context.intl.formatMessage((this.props.loggedinuser === this.props.user.uname) ? this.messages.myCollectionsTitle :this.messages.ownedCollectionsTitle)}</h1>
