...
import AttachQuestions from './AttachQuestions';
  ...
  /*Props expected:
    ...
    render() {
        ...
        if(!this.state.showSlides){//no deck selected, displaying next button
            ...
            segmentPanelContent = <AttachQuestions numColumns="3" />;
        ...
        let attachSlideBtn = <Popup trigger={<i tabIndex="0" className="help icon">}/>;
