...
class AttachQuestions extends React.Component{
...
AttachQuestions.contextTypes = {
    executeAction: PropTypes.func.isRequired
};
AttachQuestions = connectToStores(AttachQuestions,[UserProfileStore,AttachSubdeckModalStore],(context,props) => {
    return {
