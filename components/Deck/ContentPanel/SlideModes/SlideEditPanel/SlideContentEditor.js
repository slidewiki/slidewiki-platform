...
class SlideContentEditor extends React.Component {
    ...
    applyTemplate(template){
        switch (template) {
            case '1':
                ...
                this.refs.inlineContent.innerHTML = '<div class="pptx2html" style="position: relative; width: 960px; height: 720px;"><div class="bodySlide ' + this.revealStyle.bodySlide + '">'+
            ...
            case '3':
                this.refs.inlineContent.innerHTML = ''+
                    '<div class="h-mid"><h3>Title</h3></div>'+
                    '<p>text</p>';
                this.inputBoxButtonTitle = 'Switch to canvas with input boxes';
                break;
            case '11':
            ...
            case '11img':
                this.refs.inlineContent.innerHTML = '<div class="pptx2html" style="width: 960px; height: 720px; position: relative; border-style: ridge ridge ridge ridge; border-color: rgb(218, 102, 25); transform: scale(1.14479, 1.14479); transform-origin: left top 0px;">'+
                    ...
                    '<p>&nbsp;</p></div></div></div></div>', 'Add input box';
                break;
            case 'title':
                this.refs.inlineContent.innerHTML =
    ...
    */
    ...
    render() {
        ...
        // FURTHER HACK: Currently written in Presentation.js, SlideViewPanel and SlideContentEditor
                        ...
                        <div className={[style.slides, 'slides'].join(' ')}>
                            <section className="present"  style={sectionElementStyle}>
                                <HotKeys keyMap={keyMap} handlers={handlers}>
                                    <div style={contentStyle} contentEditable='true' name='inlineContent' ref='inlineContent' id='inlineContent' onInput={this.emitChange} dangerouslySetInnerHTML={{__html:slideContent}}></div>
                                </HotKeys>
                            </section>
                        </div>
                    </div>
