    ...
    getSlides(){
        ...
        if (slides) {
            html = slides.map((slide) => {
                ...
                let resultingSlide = <section dangerouslySetInnerHTML={{__html:content}} id={'slide-' + slide.id} key={slide.id} data-transition={transition} data-theme={theme}/>;
                ...
                if (bgImgTemp.length > 1) {
                    ...
                    if (backgroundImageExtr) {
                        ...
                        // Add resulting slide.
                        resultingSlide = <section data-background-image={backgroundImageExtr} dangerouslySetInnerHTML={{__html:content}} id={'slide-' + slide.id} key={slide.id} data-transition={transition}  data-theme={theme}/>;
                    } else {
                    ...
                    if (backgroundColour) {
                        resultingSlide = <section data-background-color={backgroundColour} dangerouslySetInnerHTML={{__html:content}} id={'slide-' + slide.id} key={slide.id} data-transition={transition} data-theme={theme}/>;
                    } else {
