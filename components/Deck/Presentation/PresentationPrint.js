        ...
        if(slides){
            ...
            for (let i = offset * threshold; i < max ; i++) {
                ...
                if(slide.speakernotes && slide.speakernotes.trim()){
                    notes = <div className="ui segment"><strong><i className="ui icon caret square up"></i> Speaker Notes</strong><div dangerouslySetInnerHTML={{__html: slide.speakernotes.replace('position: absolute;','')}}></div></div>;
                }
