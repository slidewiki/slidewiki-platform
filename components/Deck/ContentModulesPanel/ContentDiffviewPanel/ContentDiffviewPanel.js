...
export default class ContentDiffviewPanel extends Component {
    ...
    diff = (e) => {
        ...
        let src2 = '<div name="inlineContent" id="inlineContent" style="min-width: 100%; min-height: 450px; overflow: auto;"><h1 id="h1-1">STatic text part 1</h1><p id="p-1">NOW text</p><p id="p-2">Static</p><p id="p-3"><span id="sp-1" style="color:#f1c40f;">Color in yellow</span></p><h2 id="h2-1">Title 1</h2><h1 id="h1-2">NEWEST TITLE</h1></div>';
        src2 = src2.replace(/&nbsp;/g, ' ');
