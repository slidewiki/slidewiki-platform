            ...
            <div className="ui segments">
                {this.props.UserProfileStore.username === '' ? '':
                    <div className="3 fluid ui icon large buttons">
                        <div className="ui basic disabled attached button" aria-label="Theme" data-tooltip="Theme" onClick={this.handleTheme.bind(this)}>
                            <i className="theme black icon"></i>
                        </div>
                        <div className="ui basic attached button" aria-label="Fork Deck" data-tooltip="fork Deck" onClick={this.handleFork.bind(this)}>
                            <i className="fork black icon"></i>
                        </div>
                        <div className="ui basic disabled attached button"  aria-label="Translate" data-tooltip="Translate" onClick={this.handleTranslation.bind(this)}>
