...
*/
    ...
    openChooseLanguageModal() {
        ...
        swal({
            ...
            html: '<p>Translations of this deck are available. You may choose one of these to view the slides in this langauge instead of the langauge the presenter chose to present. You are always able to change this again.',
            type: 'info',
            input: 'select',
            inputValue: this.deckLanguage,
            inputOptions: tmp,
    ...
    render() {
        let toRender = '';
        if(/*this.props.isInitiator === true &&*/ this.state.translationsAvailable)
            toRender = <Button content='Choose other langauge' labelPosition='right' icon='check' color='blue' role="button" aria-label="Choose other langauge" onClick={this.openChooseLanguageModal.bind(this)}/>;
