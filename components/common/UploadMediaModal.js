            ...
            content = <div>
              ...
              <form className="ui form" onSubmit={this.submitPressed.bind(this)}>
                <div className="required field">
                  ...
                  <Input aria-required="true" id="title" defaultValue={this.state.files[0].name} ref="mediaTitle" name="title" onChange={this.handleChange.bind(this)} required/>
                </div>
                <div className="required field">
                  <label htmlFor="UploadMediaModal_input_mediaAltText">Description/Alt Text:</label>
                  <Popup trigger={<input ref="mediaAltText" aria-required="true" id="UploadMediaModal_input_mediaAltText" name="alt" onChange={this.handleChange.bind(this)} required/>} content='What does the picture mean?' position='top center'/>
                </div>
                <div className="required field">
                  <label htmlFor="medialicense">Choose a license:</label>
                  <Dropdown aria-required="true" id="medialicense" selection options={[{text: 'CC0 Public Domain', value: 'CC0'},{text: 'CC-BY Creative Commons Attribution 4.0', value: 'CC BY 4.0'},{text: 'CC-BY-SA Creative Common Attribution Share-Alike 4.0', value: 'CC BY SA 4.0'}]} defaultValue='CC0' onChange={this.changeLicense.bind(this)} ref="mediaLicense" required/>
                </div>
                {licenseBoxes}
                <div className="required field">
                  <div className="ui checkbox">
                    <input type="checkbox" aria-required="true" htmlFor="confirm" required/>
                    <label htmlFor="confirm">I confirm that I have the rights to upload this image as per the SlideWiki <a href="/imprint">terms and conditions</a> and that the <a href="/license">license information</a> I have provided is correct.</label>{/*TODO Add a link to the slidewiki terms/cond site, currently not exising*/}
                  </div>
                </div>
