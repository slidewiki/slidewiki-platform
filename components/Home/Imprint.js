                ...
                <div className="ui container grid" ref="imprint">
                    <div className="ui row">
                        <div className="ui content">
                            <h1 className="ui header" id="main">Imprint – also serves as provider identification according to &sect; 5 Telemediengesetz (TMG)</h1>
                            <h2>Provider:</h2>
