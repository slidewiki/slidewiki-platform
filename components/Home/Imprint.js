                ...
                <div className="ui container grid" ref="imprint">
                    <div className="ui row">
                        <div className="ui content">
                            ...
                            <h2><FormattedMessage id="imprint.provider" defaultMessage="Provider"/>:</h2>
                            <p>Technische Informationsbibliothek (TIB)<br/>Welfengarten 1 B, 30167 Hannover<br/><br/>Postfach 6080, 30060 Hannover</p>
                            <h2><FormattedMessage id="imprint.representative" defaultMessage="Authorised Representative"/>:</h2>
                            ...
                            <p><strong><FormattedMessage id="imprint.content.text1" defaultMessage="Provided as-is:"/></strong>&nbsp;
                            ...
                            <h2><FormattedMessage id="imprint.content2" defaultMessage="Content Supplied by You"/></h2>
                            ...
                            <h2><FormattedMessage id="imprint.disclaimer" defaultMessage="Disclaimer"/></h2>
