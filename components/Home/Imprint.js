                ...
                <div className="ui container grid" ref="imprint">
                    <div className="ui row">
                        <div className="ui content">
                            ...
                            <p><FormattedMessage id="imprint.representative.text" defaultMessage="Prof. Dr. Sören Auer (Director of TIB)<br/><br/>Technische Informationsbibliothek (TIB) is a foundation of public law of the state of Lower Saxony."/></p>
