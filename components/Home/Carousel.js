                ...
                <div className="ui fluid container two column grid" style={{minHeight: '200px'}}>
                                ...
                                <ul className="glide__track">
                                    <li className="glide__slide" >
                                        <a href="http://slidewiki.org" className="ui medium image" tabIndex="-1">
                                            <img src="/assets/images/carousel/SW-deck.png" alt="Create slidew with SlideWiki." />
                                        </a>
                                    </li>
                                    <li className="glide__slide" >
                                        <a href="http://slidewiki.org" className="ui medium image" tabIndex="-1">
                    ...
                    <div className="four wide column">
                        <div className="ui fluid vertical divided menu">
                            ...
                            <button onClick={this.togglePause.bind(this)} className="ui tiny secondary button" aria-label="pause carousel">{this.state.paused ? <i className="ui play icon"></i> : <i className="ui pause icon"></i>}</button>
                        </div>
