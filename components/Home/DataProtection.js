                ...
                <div className="ui row">
                    <div className="twelve wide centered column">
                        <div className="ui content">
                            <h2 className="ui header">Statement of Data Protection Conditions</h2>
                            <p>The Fraunhofer-Gesellschaft zur Förderung der angewandten Forschung e.V. (Fraunhofer-Gesellschaft) takes the protection of your personal data very seriously. When we process the personal data that is collected during your visits to our Web site, we always observe the rules laid down in the applicable data protection laws. Your data will not be disclosed publicly by us, nor transferred to any third parties without your consent.</p>
                            <p>In the following sections, we explain what types of data we record when you visit our Web site, and precisely how they are used:</p>
                            ...
                            <p>You can cancel your registration for this type of service at any time, by sending us an e-mail via the Web page offering the service.</p>
                            <p>As a general rule, the content of visitors’ books and forums is not subject to any form of monitoring by the Fraunhofer-Gesellschaft. Nevertheless, we reserve the right to delete posted contributions and to prohibit users from further use of the service at our own discretion, especially in cases where posted content contravenes the law or is deemed incompatible with the objectives of the Fraunhofer-Gesellschaft.</p>
                            <h3>5. Cookies</h3>
                            ...
                            <h3>6. Security</h3>
                            <p>The Fraunhofer-Gesellschaft implements technical and organizational security measures to safeguard stored personal data against inadvertent or deliberate manipulation, loss or destruction and against access by unauthorized persons. Our security measures are continuously improved in line with technological progress.</p>
                            <h3>7. Links to Web sites operated by other providers</h3>
                            <p>Our Web pages may contain links to other providers’ Web pages. We would like to point out that this statement of data protection conditions applies exclusively to the Web pages managed by the Fraunhofer-Gesellschaft. We have no way of influencing the practices of other providers with respect to data protection, nor do we carry out any checks to ensure that they conform with the relevant legislation.</p>
                            <h3>8. Right to information and contact data</h3>
                            <p>You have a legal right to inspect any stored data concerning your person, and also the right to demand their correction or deletion, and to withdraw your consent for their further use.</p>
                            <p>In some cases, if you are a registered user of certain services provided by the Fraunhofer-Gesellschaft, we offer you the possibility of inspecting these data online, and even of deleting or modifying the data yourself, via a user account.</p>
                            <p>If you wish to obtain information on your personal data, or want us to correct or erase such data, or if you have any other questions concerning the use of personal data held by us, please contact:</p>
                            <p>data-protection(at)zv.fraunhofer.de</p>
                            <h3>9. Acceptance, validity and modification of data protection conditions</h3>
                            <p>By using our Web site, you implicitly agree to accept the use of your personal data as specified above. This present statement of data protection conditions came into effect on October 1st, 2013. As our Web site evolves, and new technologies come into use, it may become necessary to amend the statement of data protection conditions. The Fraunhofer-Gesellschaft reserves the right to modify its data protection conditions at any time, with effect as of a future date. We recommend that you re-read the latest version from time to time.</p>
                        </div>
                    </div>
                </div>
            </div>
