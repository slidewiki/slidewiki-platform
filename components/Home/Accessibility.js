    ...
    render() {
        return (
            <div className="ui text container" ref="accessibility">
                ...
                <p><FormattedMessage id="accessibility.1.p4" defaultMessage="Examples of items checked for accessibility include:"/></p>
                <ul>
                ...
                <div className="ui warning message"><FormattedMessage id="accessibility.1.p5." defaultMessage="However, we cannot guarantee the accessibility of external information linked to or from SlideWiki or the content provided by users on their personal/group decks or slides.  Action has been taken to provide templates and other options to ensure it is possible to make the content added to decks and slides accessible."/></div>
                <p><FormattedMessage id="accessibility.1.p6" defaultMessage="As we are continuously updating our website, exceptions to the above accessibility standards may sometimes inadvertently be introduced. Please let us know if you have difficulty accessing any of our content."/></p>
                
                <h2 className="ui header"><FormattedMessage id="accessibility.2.header" defaultMessage="Technologies used in the SlideWiki Platform"/></h2>
                <p><FormattedMessage id="accessibility.2.p1" defaultMessage="The platform relies on the following technologies: HTML5, CSS, react-js and uses WAI-ARIA to support accessibility."/></p>
                <p><FormattedMessage id="accessibility.2.p2" defaultMessage="It is compatible with a range of browsers: Chrome, Firefox and Edge. However compatibility with Internet Explorer 11 or earlier is limited and we recommend using an alternative browser."/></p>
                <p><FormattedMessage id="accessibility.2.p3" defaultMessage="These browsers have been tested with the following assistive technologies: Jaws 18, NVDA 2007, VoiceOver on Mac and iOS and TalkBack on Android screen readers as well as a range of input/output devices that emulate keyboard navigation."/></p>
                <p>
                    values={{
                ...
                <p><FormattedMessage id="accessibility.date" defaultMessage="Last updated 6th February 2018"/></p>
                     </div>
