    ...
    render() {
        return (
            <div className="ui text container" ref="terms">
                ...
                <h1 className="ui header">Terms of use of SlideWiki</h1>
                <p>This is a human-readable <b>summary</b> of the Terms of Use.</p>
                <p>Disclaimer: This summary is not a part of the Terms of Use for the SlideWiki (the project) and is not a legal document. It is simply a handy reference for understanding the full terms. Think of it as the user-friendly interface to the legal language of our Terms of Use.</p>
                ...
                <ul className="ui list">
                    <li> <b>Read and Print</b> our presentations and other media free of charge.
                    </li>
                    <li> <b>Share and Reuse</b> our presentations and other media under free and open licenses.
                    </li>
                    <li> <b>Contribute To and Edit</b> our various sites or projects.
                    </li>
                </ul>
                <h2 className="ui header">Under the following conditions</h2>
                <ul className="ui list">
                    <li> <b>Responsibility</b> &#8211; You take responsibility for your edits (since we only <i>host</i> your content).
                    </li>
                    <li> <b>Civility</b> &#8211; You support a civil environment and do not harass other users.
                    </li>
                    <li> <b>Lawful behaviour</b> &#8211; You do not violate copyright or other laws.
                    </li>
                    <li> <b>No Harm</b> &#8211; You do not harm our technology infrastructure.
                    </li>
                    <li> <b>Terms of Use and Policies</b> &#8211; You adhere to the Terms of Use and to the applicable community policies when you visit our sites or participate in our communities.
                    </li>
                </ul>
                <h2 className="ui header">With the understanding that</h2>

                <ul className="ui list">
                    <li>This service may contain <b>translations</b> powered by third-party translation services.  We disclaims all warranties related to the translations, expressed or implied, including any warranties of accuracy, reliability, and any implied warranties of merchantability, fitness for a particular purpose and noninfringement.
                    </li>
                    <li>If you choose to translate content then data maybe sent to third-party service providers.</li>
                    <li> <b>You license freely your contributions</b> &#8211; you generally must license your contributions and edits to our sites or Projects under a free and open <NavLink href="/license">Creative Commons licenses</NavLink> (unless your contribution is in the public domain).
                    </li>
                ...
                <h2 className="ui header">Refraining from Certain Activities</h2>
                <p>We reserve the rights to remove content that we consider to be inappropriate, offensive or spam. Certain activities, whether legal or illegal, may be harmful to other users and violate our rules, and some activities may also subject you to liability. Therefore, for your own protection and for that of other users, you may not engage in such activities on our site. These activities include:</p>
                

                <h3 className="ui header">Harassing and Abusing Others</h3>
                <ul className="ui list">
                ...
                <h3 className="ui header">Violating the Privacy of Others</h3>
                <ul className="ui list">
                    <li>Infringing the privacy rights of others under the laws of the European Union or other applicable laws (which may include the laws where you live or where you view or edit content);</li>
                    <li>Soliciting personally identifiable information for purposes of harassment, exploitation, violation of privacy, or any promotional or commercial purpose not explicitly approved by the Project; and</li>
                ...
                <h3 className="ui header">Engaging in False Statements, Impersonation, or Fraud</h3>
                <ul className="ui list">
                ...
                <h3 className="ui header">Misusing Our Services for Other Illegal or Inappropriate Purposes</h3>  
                <ul className="ui list">
                    ...
                    <li>Posting content for the purposes of advertising, commercial, marketing, or promotional activities that are intended to solicit users to buy or sell services or to make donations.</li>
                </ul>
                ...
                <ul className="ui list">
                    ...
                    <li>Engaging in automated uses of the site that are abusive or disruptive of the services;</li>
                ...
                <h3 className="ui header">Compatibility with Wikimedia's terms of use</h3>  
                <p>Our terms are adapted from the <a href="http://wikimediafoundation.org/wiki/Terms_of_Use">Wikimedia terms of use</a>, which are available under the <a href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution/Share-Alike</a> License.
                </p>
                <p>For full terms and conditions please read our <NavLink href="/imprint">Imprint page.</NavLink></p>
            </div>
