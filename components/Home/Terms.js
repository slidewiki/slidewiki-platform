    ...
    render() {
        return (
            <div className="ui text container" ref="terms">
                ...
                <p>This is a human-readable <b>summary</b> of the Terms of Use for SlideWiki (the project).</p>
                ...
                <ul className="ui list">
                    <li>Infringing the privacy rights of others under the laws of Germany or other applicable laws (which may include the laws where you live or where you view or edit content);</li>
                ...
                <ul className="ui list">
                    ...
                    <li>Engaging in automated uses of the site that are abusive or disruptive of the services and have not been approved by the project community;</li>
                    ...
                    <ul className="ui list">
                        ...
                        <li>you report any vulnerabilities to project's developers (or fix it yourself); and</li>
                        <li>you do not undertake such actions with malicious or destructive intent.</li>
                    </ul>
                </ul>

                <h3 className="ui header">Compatibility with Wikipedia's terms of use</h3>  
                <p>Our terms are adapted from the <a href="http://wikimediafoundation.org/wiki/Terms_of_Use">Wikipedia terms of use</a>, which are available under the <a href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution/Share-Alike</a> License.
                </p>
