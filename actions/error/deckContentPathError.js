...
export default function deckContentPathError(context, payload, done) {
    logger.error('Invalid deck content path.', {deck_id: payload.params.id, spath: payload.params.spath, reqId: payload.navigate.reqId, breadcrumb: breadcrumb(context.stack)});
