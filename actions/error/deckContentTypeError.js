...
export default function deckContentTypeError(context, payload, done) {
    logger.error('Invalid deck content type.', {deck_id: payload.params.id, stype:payload.params.stype, reqId: payload.navigate.reqId, breadcrumb: breadcrumb(context.stack)});
